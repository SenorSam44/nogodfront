<template>
  <div class="seller-login">
    ...
    <b-form @submit.stop.prevent="onSubmit" class="main-form">
      ...
      <b-form-group label="I am a...">
        <b-form-radio v-model="$v.form.type.$model" :aria-describedby="ariaDescribedby"
                      name="type" value="merchant">
          Merchant
        </b-form-radio>
        <b-form-radio v-model="$v.form.type.$model" :aria-describedby="ariaDescribedby"
                      name="type" value="local_entrepreneur">
          Local Entrepreneur
        </b-form-radio>

        <b-form-radio v-model="$v.form.type.$model" :aria-describedby="ariaDescribedby"
                      name="type" value="book_seller">
          Book Seller
        </b-form-radio>
      </b-form-group>
